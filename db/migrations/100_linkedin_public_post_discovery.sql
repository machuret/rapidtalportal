...
-- Treat public LinkedIn company posts feeds as collectable market context.
-- ============================================================
...
WHERE platform = 'linkedin'
  ...
  AND normalized_url ~* '^https://([a-z0-9-]+\.)?linkedin\.com/company/[a-z0-9][a-z0-9-]{0,99}/posts/?(\?feedview=all)?$';
...
VALUES ('100_linkedin_public_post_discovery.sql')
